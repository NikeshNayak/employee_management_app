...
class _AddEmployeeDetailsPageState extends State<AddEmployeeDetailsPage> {
  ...
  void _saveEmployeeDetails() {
    ...
    BlocProvider.of<AddEmployeeDetailsBloc>(context).add(
      AddEmployeeDetailsDataEvent(
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AddEmployeeDetailsBloc, AddEmployeeDetailsState>(
      listener: (context, state) {
        if (state is AddEmployeeDetailsSuccessState) {
          showSnackMessage(
            context: context,
            title: 'Success',
            text: state.message ?? '',
        ...
        } else if (state is AddEmployeeDetailsFailedState) {
          showSnackMessage(context: context, title: 'Error', text: state.message ?? '', icon: Icons.error);
        } else if (state is AddEmployeeDetailsExceptionState) {
          showSnackMessage(context: context, title: 'Error', text: state.message ?? '', icon: Icons.error);
        }
      },
