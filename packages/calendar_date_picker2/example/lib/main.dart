...
class _MyHomePageState extends State<MyHomePage> {
  ...
  _buildCalendarDialogButton() {
    ...
    final config = CalendarDatePicker2WithActionButtonsConfig(
      ...
      selectedRangeDecorationPredicate: (
          {required dayToBuild, required decoration, required isEndDate, required isStartDate}) {
      ...
      selectedRangeHighlightBuilder: ({required dayToBuild, required isEndDate, required isStartDate}) {
  ...
  Widget _buildRangeDatePickerWithValue() {
    final config = CalendarDatePicker2Config(
      ...
      modePickerBuilder: ({
        ...
        return Center(
          child: Container(
            ...
            child: Text(
              isMonthPicker == true
                  ? getLocaleShortMonthFormat(const Locale('en')).format(monthDate)
      ...
      disabledDayTextStyle: const TextStyle(color: Colors.grey, fontWeight: FontWeight.w400),
      selectableDayPredicate: (day) {
        if (_rangeDatePickerValueWithDefaultValue.isEmpty || _rangeDatePickerValueWithDefaultValue.length == 2) {
          // exclude Wednesday
          ...
          for (var date = range.first; date.compareTo(range.last) <= 0; date = date.add(const Duration(days: 1))) {
