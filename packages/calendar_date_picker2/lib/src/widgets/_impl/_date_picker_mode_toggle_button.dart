...
class _DatePickerModeToggleButtonState extends State<_DatePickerModeToggleButton> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    final isMonthOrYearMode =
        widget.mode == CalendarDatePicker2Mode.year || widget.mode == CalendarDatePicker2Mode.month;
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        children: <Widget>[
          if (widget.mode == CalendarDatePicker2Mode.day && widget.config.centerAlignModePicker == true)
            ...
            Flexible(
              child: Semantics(
                ...
                child: SizedBox(
                  height: (widget.config.controlsHeight ?? _subHeaderHeight),
                  child: InkWell(
                    onTap: widget.config.disableModePicker == true ? null : widget.onYearPressed,
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              Flexible(
                                child: Text(
                                  widget.config.modePickerTextHandler?.call(monthDate: widget.monthDate) ??
                                      _localizations.formatMonthYear(widget.monthDate),
                ...
                children: [
                  Semantics(
                    ...
                    child: SizedBox(
                      height: (widget.config.controlsHeight ?? _subHeaderHeight),
                      child: InkWell(
                        onTap: widget.config.disableModePicker == true ? null : widget.onMonthPressed,
                        child: widget.config.modePickerBuilder?.call(
                              viewMode: widget.mode,
                              monthDate: widget.monthDate,
                              isMonthPicker: true,
                                  ...
                                  Flexible(
                                    child: Text(
                                      widget.config.modePickerTextHandler?.call(
                                          ...
                                          (widget.config.useAbbrLabelForMonthModePicker == true
                  ...
                  SizedBox(
                    width: widget.config.modePickersGap ?? (widget.config.centerAlignModePicker == true ? 15 : 5),
                  ),
                  Semantics(
                    label: widget.config.semanticsDictionary?[CalendarDatePicker2SemanticsLabel.selectYear] ??
                        MaterialLocalizations.of(context).selectYearSemanticsLabel,
