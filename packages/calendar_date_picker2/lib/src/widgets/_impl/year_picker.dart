...
class _YearPickerState extends State<YearPicker> {
  ...
  void initState() {
    ...
    _scrollController = widget.config.yearViewController ?? ScrollController(initialScrollOffset: scrollOffset);
  }
  ...
  Widget _buildYearItem(BuildContext context, int index) {
    ...
    final yearSelectableFromPredicate = widget.config.selectableYearPredicate?.call(year) ?? true;
    final isDisabled =
        (year < widget.config.firstDate.year || year > widget.config.lastDate.year) || !yearSelectableFromPredicate;
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: <Widget>[
        Divider(
          color: widget.config.hideYearPickerDividers == true ? Colors.transparent : null,
        ),
        Expanded(
