...
class CalendarDatePicker2Config {
  CalendarDatePicker2Config({
    ...
    this.controlsHeight,
    this.lastMonthIcon,
    this.lastMonthHeight,
    this.lastMonthWidth,
    this.hideLastMonthIcon,
    this.nextMonthIcon,
    this.nextMonthHeight,
    this.nextMonthWidth,
    ...
    this.dayTextStyle,
    this.selectedDateCustomWidget,
    this.customSelectedDateTextStyle,
    this.lightBlueColor,
    this.isStartRange,
  ...
  final double? lastMonthHeight;

  final double? lastMonthWidth;
  ...
  final Widget? selectedDateCustomWidget;

  final TextStyle? customSelectedDateTextStyle;
  ...
  CalendarDatePicker2Config copyWith({
    ...
    double? lastMonthHeight,
    double? lastMonthWidth,
    bool? hideLastMonthIcon,
    Widget? nextMonthIcon,
    double? nextMonthHeight,
    double? nextMonthWidth,
    ...
    return CalendarDatePicker2Config(
      ...
      lastMonthHeight: lastMonthHeight ?? this.lastMonthHeight,
      lastMonthWidth: lastMonthWidth ?? this.lastMonthWidth,
      hideLastMonthIcon: hideLastMonthIcon ?? this.hideLastMonthIcon,
      nextMonthIcon: nextMonthIcon ?? this.nextMonthIcon,
      nextMonthHeight: nextMonthHeight ?? this.nextMonthHeight,
      nextMonthWidth: nextMonthWidth ?? this.nextMonthWidth,
...
class CalendarDatePicker2WithActionButtonsConfig extends CalendarDatePicker2Config {
  CalendarDatePicker2WithActionButtonsConfig({
    ...
    TextStyle? dayTextStyle,
    TextStyle? selectedDayTextStyle,
    TextStyle? customSelectedDateTextStyle,
    Widget? selectedDateCustomWidget,
    Color? lightBlueColor,
    bool? isStartRange,
    Color? selectedDayHighlightColor,
    Color? selectedRangeHighlightColor,
    ...
    this.buttonPadding,
          ...
          lastMonthHeight: lastMonthHeight,
          lastMonthWidth: lastMonthWidth,
          hideLastMonthIcon: hideLastMonthIcon,
          nextMonthIcon: nextMonthIcon,
          nextMonthHeight: nextMonthHeight,
          nextMonthWidth: nextMonthWidth,
          ...
          selectedDateCustomWidget: selectedDateCustomWidget,
          customSelectedDateTextStyle: customSelectedDateTextStyle,
  ...
  CalendarDatePicker2WithActionButtonsConfig copyWith({
    ...
    return CalendarDatePicker2WithActionButtonsConfig(
      ...
      selectedDayTextStyle: selectedDayTextStyle ?? this.selectedDayTextStyle,
      isStartRange: isStartRange ?? this.isStartRange,
      customSelectedDateTextStyle: customSelectedDateTextStyle ?? this.customSelectedDateTextStyle,
      selectedDateCustomWidget: selectedDateCustomWidget ?? this.selectedDateCustomWidget,
      selectedRangeDayTextStyle: selectedRangeDayTextStyle ?? this.selectedRangeDayTextStyle,
      lightBlueColor: lightBlueColor ?? this.lightBlueColor,
      selectedDayHighlightColor: selectedDayHighlightColor ?? this.selectedDayHighlightColor,
      selectedRangeHighlightColor: selectedRangeHighlightColor ?? this.selectedRangeHighlightColor,
